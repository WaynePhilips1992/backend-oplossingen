<?php
    ...
    $fruit2 = "ananas";
    $positieAnanas = strrpos($fruit2, 'a');
...
<html>
    ...
    <body class="web-backend-opdracht">
        ...
        <section class="body">
            ...
            Variabele fruit telt <?=$lengtefruit ?> karakters.
            Positie van "o" in <?=$fruit ?> is <?=$positie?>
            ...
            Positie laatste a = <?=$positieAnanas ?>.
            In hoofdletters: <?=$hoofdletters ?>
