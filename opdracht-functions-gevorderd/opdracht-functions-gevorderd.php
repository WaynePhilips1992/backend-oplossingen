...
function telKarakters1( $key, $search )
{
    $keyCount =  strlen( $key );
        ...
        <ul>
            ...
            <li>
                ...
                <div class="facade-minimal" data-url="http://www.app.local/index.php">
                    <p>Functie 1: De search '2' komt 6.25% voor in de hash key 'd1fa402db91a7a93c4f414b8278ce073'</p>
                    <p>Functie 2: De search '8' komt 6.25% voor in de hash key 'd1fa402db91a7a93c4f414b8278ce073'</p>
                    <p>Functie 3: De search 'a' komt 9.375% keer voor in de hash key 'd1fa402db91a7a93c4f414b8278ce073'</p>
                </div>
            </li>

        Het karakter "<?php echo $search1?>" komt <?php echo $eersteMethode ?>% voor in de string "<?php echo $md5HashKey ?>"<br/>
        Het karakter "<?php echo $search2?>" komt <?php echo $tweedeMethode ?>% voor in de string "<?php echo $md5HashKey ?>"<br/>
        Het karakter "<?php echo $search3?>" komt <?php echo $derdeMethode ?>% voor in de string "<?php echo $md5HashKey ?>"<br/>
