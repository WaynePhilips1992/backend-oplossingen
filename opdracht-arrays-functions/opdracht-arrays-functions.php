<!doctype html>
<?php 
    $listDieren = array("konijn","koe", "hond","kat","varken","LANDERISKUT");
    $countListDieren = count($listDieren);
    $teZoekenDier = "hond";
    $blnfound = "niet gevonden";

    if(in_array($teZoekenDier, $listDieren)){$blnfound = "gevonden";}
?>
<html>
<head>
    <meta charset="utf-8">
...
<body class="web-backend-opdracht">
    ...
    <section class="body">
        ...
        <ul>
            ...
            In de array zitten <?php echo $countListDieren ?> dieren.<br/>
            Het gezochte dier "<?php echo $teZoekenDier ?>" is in de array <?php echo $blnfound ?>.
