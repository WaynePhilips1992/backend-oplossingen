...
$TOTAALSECONDEN = 221108521;
$seconden = floor($TOTAALSECONDEN/60);
$minuten = floor($TOTAALSECONDEN/60*60);
$uren = floor($TOTAALSECONDEN/60*60*60);
$dagen = floor($TOTAALSECONDEN/24*60*60*60);
$weken = floor($TOTAALSECONDEN/7*24*60*60*60);
$maanden = floor($TOTAALSECONDEN/31*24*60*60*60);
$jaren = floor($TOTAALSECONDEN/365*24*60*60*60);
    		...
    		<ul>
                ...
                <li>
                    ...
                    <div class="facade-minimal" data-url="http://www.app.local/index.php">
                        ...
                        TEST op <?=$TOTAALSECONDEN?> = seconden: <?=$seconden?>, minuten: <?=$minuten?>, uren: <?=$uren?>, dagen: <?=$dagen?>, maanden: <?=$maanden?>, jaren: <?=$jaren?>
                    </div>
