...
for( $i = 0; $i <= $rijen; $i++ )
{
    ...
    for($g=0; $g<=$kolommen; $g++)
    {
        $producten[] = $i*$g;
    }

    $uitkomst[$i] = $producten;
...
<table>
    ...
    <tr>
        <?php for ( $g = 0; $g < $kolommen+1; ++$g): ?>
        <td class="<?= (($i*$g)%2>0)? 'oneven' : '' ?>"><?php echo $i*$g ?></td>
    <?php endfor ?>
</tr>
<?php endfor ?>
</table>
...
<table>
    ...
    <?php foreach ($uitkomst as $producten): ?>
    <tr>
