...
<body class="web-backend-opdracht">
    ...
    <section class="body">
        ...
        <ul>
            ...
            De som van <?php echo $getal1 ?> en <?php echo $getal2 ?> is <?php echo $som ?>.<br/>
            Het product van <?php echo $getal1 ?> en <?php echo $getal2 ?> is <?php echo $product ?> <br/>
            Het getal <?php echo $getal1 ?> is <?php if($pariteit): ?> even<?php else: ?> oneven<?php endif ?>.
